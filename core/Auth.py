...
OAuth2 = OAuth2PasswordBearer(setting.SWAGGER_UI_OAUTH2_REDIRECT_URL, scheme_name="User",
...
def create_access_token(data: dict):
    ...
    # token超时时间
    expire = datetime.utcnow() + timedelta(minutes=setting.JWT_ACCESS_TOKEN_EXPIRE_MINUTES)
    # 向jwt加入超时时间
